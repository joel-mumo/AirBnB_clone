#!/usr/bin/python3
""" This is a file storage that serializes an instance to a JSON file
    Deserializes a JSON file to an instance (JSON.load)
"""
import json
...
class FileStorage:
    """This class serializes instance to a JSON
    file and deserializes JSON to instance"""
